...
function ConsentPage({apiUrl}) {
    ...
    const handleConsentClick = (consent) => {
     ...
     return (
      ...
      <div><div className = 'info' style={{width: 'max-content', marginLeft:'9%', marginTop:'4%'}}>Hello! Thank you for participating in this study! First we need to get your informed consent to continue. <br/><br/> Please read the following information. </div>

      <div style={{width: '80%', marginLeft:'9%', marginTop:'2%'}}>
