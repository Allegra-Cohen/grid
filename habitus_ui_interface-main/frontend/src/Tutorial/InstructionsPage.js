        ...
        <div className='container'>
            <div className="loginPageCard">
                <div style={{ marginBottom: 10 }}>
                    Today you will be working with a corpus of expert knowledge about <b>rice harvesting</b> in the Senegal River Valley.
                ...
                <div>
                    <Button color="blue" label="Click here to begin" icon="mi:next" onClick={() => handleToCuration()} />
                </div>
            </div>
        </div>
    );
