...
export default function ChangeCorpus({apiurl}) {
	...
	return (
      ...
      {error === false ? <div style={{marginLeft: '-8%', margin: '0.5%', padding: '1%', textAlign:'center'}}>All done! Your corpus is now ready to be used. <br/>The corpus name is <b>{corpusFile}.csv</b> and its associated default row labels are stored in <b>{rowsFile}</b>.</div> : <div/> }
