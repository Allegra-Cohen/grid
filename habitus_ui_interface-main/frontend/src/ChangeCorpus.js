...
export default function ChangeCorpus({apiUrl}) {
	...
	return (
      ...
      <div className='info' style={{width:'max-content', marginLeft:'31%',  fontSize:'14pt'}} onKeyUp={(evt) => handleInput(evt.target.value)}>
      ...
      <div>
      {error ? <div style={{marginLeft: '26%', margin: '0.5%', padding: '1%', color: 'red'}}>Cannot locate {filepath}.</div> : <div/> }
