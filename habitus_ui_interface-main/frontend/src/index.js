...
root.render(
  ...
  <Routes>
    ...
    <Route path="/instructions" element={<div style={{marginLeft:'200px', marginTop:'60px', width: '1200px'}}>Today you will be working with a corpus of expert knowledge about rice harvesting in the Senegal River Valley. You will have 30 minutes to organize the expert knowledge using the Grid tool. When you are done, you will be tested on the important concepts in this corpus, so please organize your Grid in such a way that you can find information quickly. If you are finished organizing your Grid before your 30 minutes are up, you may move on to the next page to answer questions about the corpus. When you move on, your Grid will appear on the next page but you will not be allowed to edit it or return to the editing page. <Link to="/grid">Click here to begin.</Link></div>}/>
